...
console.log('\nOtros casos')
{
  ...
  console.log('numeros:', numeros) // [13]
  console.log('elemento:', elemento) // { nombre: 'Nombre Apellido', edad: 42 }
}
console.log('\nUso de los nombres de propiedades con la extracción de un objeto')
{
  let uno = { nombre: 'NombreUno', edad: 42 }
...
{
  let dos = { nombre: 'NombreDos', edad: 42, }
  let { nombre, edad } = dos
  /*
...
console.log('\nUso de paréntesis para inicializar variables')
{
  ...
  let edad = undefined
  const tres = { nombre: 'NombreTres', edad: 28, }; //Se requiere punto y coma, como también paréntesis
  ({nombre, edad} = tres)
